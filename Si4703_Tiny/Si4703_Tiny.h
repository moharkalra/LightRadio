...
#ifndef Si4703_Tiny_h
#define Si4703_Tiny_h
...
{
  public:
    Si4703_Tiny(int resetPin, int sdioPin, int sclkPin);
	...
	void setSeekThresh(uint16_t thresh);
	void setSNRThresh(uint16_t thresh);
	int getChannel();
	int readRSSI();
  private:
    int  _resetPin;
	...
	static const uint16_t  CHIPID1 = 0x01;
